...
public class BairroServices {
    ...
    //Receber uma instância de BairroRepository no construtor dessa classe BairroServices e atribuir ao noso atributo
    ...
    //Construtor recebendo (BairroRepository) e vai atribuir ao this.repository o que le recebeu por parâmetro (repository)
